...
static int gfx_cmd_to_batch_entry(const gfx_cmd_t *cmd,
    ...
    switch (cmd->cmd_type) {
        ...
        case GFX_CMD_GET_PIXEL: {
            fmrb_link_graphics_get_pixel_t c = {
                .canvas_id = cmd->canvas_id,
                .x = cmd->params.get_pixel.x,
                .y = cmd->params.get_pixel.y,
            };
            *sub_cmd_out = FMRB_LINK_GFX_GET_PIXEL;
            memcpy(payload_buf, &c, sizeof(c));
            return sizeof(c);
        }
        ...
        case GFX_CMD_DELETE_CANVAS: {
            fmrb_link_graphics_delete_canvas_t c = {
                .canvas_id = cmd->canvas_id
            };
            *sub_cmd_out = FMRB_LINK_GFX_DELETE_CANVAS;
            memcpy(payload_buf, &c, sizeof(c));
            return sizeof(c);
        }
        ...
        case GFX_CMD_SET_SPRITE_CLIP: {
            fmrb_link_graphics_set_sprite_clip_t c = {
                .canvas_id = cmd->canvas_id,
                .x = cmd->params.set_sprite_clip.x,
                .y = cmd->params.set_sprite_clip.y,
                .w = cmd->params.set_sprite_clip.w,
                .h = cmd->params.set_sprite_clip.h,
            };
            *sub_cmd_out = FMRB_LINK_GFX_SET_SPRITE_CLIP;
            memcpy(payload_buf, &c, sizeof(c));
            return sizeof(c);
        }
