...
class EditorApp < FmrbApp
  ...
  # Quit-confirm dialog frame. Kept on the editor body (not in editor/render.rb)
  # because editor/search.rb reuses these for its dialog too; both mixins reach
  # them as self.class::QUIT_DLG_*.
