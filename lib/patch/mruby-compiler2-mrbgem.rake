MRuby::Gem::Specification.new('mruby-compiler2') do |spec|
  ...
  # Add prism_alloc.c to the build
  prism_alloc_src = "#{dir}/include/prism_alloc.c"
  prism_alloc_obj = objfile("#{build_dir}/lib/prism_alloc")
  objs << prism_alloc_obj
  file prism_alloc_obj => [prism_alloc_src] do |f|
