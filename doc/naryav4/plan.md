...
| 映像 | 2-lane MIPI-DSI (15pin FPC) → LT8912B → HDMI 800x600@60 横 (P0 で決着) | DSI 直結パネル 720x1280 縦 |
...
3. FB の RGB888 化 (LT8912B は RGB888 入力のみ、800x600 で 1.44MB PSRAM)
   と PPA SRM の出力形式変更、**回転なしの 1.5x** で 426x240 → 639x360 +
   黒縁 (左右 80px、上下 120px)。
